// Pool icon set — inline SVGs matching the design file exactly
...
export function HomeIcon({ size = 20, className, filled }: IconProps) {
  return filled ? (
    <svg
      width={size}
      height={size}
...
export function DotsVerticalIcon({ size = 20, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function TravelIcon({ size = 20, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function HomeGroupIcon({ size = 20, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function UpiIcon({ size = 20, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
